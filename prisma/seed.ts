...
if (!connectionString) {
  throw new Error('DATABASE_URL در فایل .env پیدا نشد.')
}
...
async function main() {
  console.log('🚀 شروع seed PostgreSQL...')
    ...
    data: [
      {
        ...
        description:
          'ربات هوشمند تلگرام برای مدیریت خودکار سفارشات، پرداخت‌ها و ارتباط با مشتریان. این ربات تمام فرآیند فروش شما را اتوماتیک می‌کند.',
        shortDesc:
          'مدیریت خودکار سفارشات تلگرام با قابلیت پرداخت آنلاین',
        priceBase: 2900000,
        pricePro: 5900000,
        priceOrg: 12900000,
      ...
      },
      {
        ...
        description:
          'سیستم جامع مدیریت فرآیندهای اداری، دبیرخانه و گردش کار. مناسب برای سازمان‌ها و شرکت‌های متوسط و بزرگ.',
        shortDesc:
          'مدیریت هوشمند فرآیندهای اداری و دبیرخانه',
        priceBase: 9900000,
        pricePro: 19900000,
        priceOrg: 39900000,
        features: JSON.stringify([
      ...
      },
      {
        ...
        description:
          'خدمات مشاوره و پیاده‌سازی راهکارهای هوش مصنوعی برای کسب‌وکارها. از تحلیل نیازمندی تا پیاده‌سازی کامل.',
        shortDesc:
          'مشاوره تخصصی پیاده‌سازی AI در کسب‌وکار',
        priceBase: 4900000,
        pricePro: 9900000,
        priceOrg: 19900000,
        features: JSON.stringify([
      ...
      },
      {
        ...
        shortDesc:
          'طراحی سایت مدرن با React/Next.js',
        priceBase: 7900000,
        pricePro: 14900000,
        priceOrg: 29900000,
        features: JSON.stringify([
    ...
    data: [
      {
        ...
        content:
          'ربات سفارش‌گیر تلگرام فوق‌العاده است! در ماه اول ۴۰٪ افزایش فروش داشتم. پشتیبانی هم عالیه.',
      ...
      },
      {
        ...
        role: 'کارآفرین',
        content:
          'پشتیبانی عالی و راه‌اندازی سریع. دقیقاً همون چیزی بود که نیاز داشتم. قیمت هم منصفانه است.',
      ...
      },
      {
        ...
        content:
          'بهترین سرمایه‌گذاری برای کسب‌وکارم. اتوماسیون کامل و بدون خطا. گزارش‌گیری عالی داره.',
  ...
  console.log('🎉 Seed PostgreSQL با موفقیت کامل شد!')
}
